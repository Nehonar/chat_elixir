defmodule ChatElixir.Helpers.SqlitexHelper do
    ...
    defmodule Insert_data do
        ...
        def insert_data_init(params) do
        ...
        def insert_params(%Error{} = error), do: error
    end
